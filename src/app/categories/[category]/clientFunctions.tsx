...
////TODO filters
export default function LoadProducts({currentCategory,categoryDescription,products,item_images}:{currentCategory:string,categoryDescription:string | null,products:item[],item_images:string[]}) {
